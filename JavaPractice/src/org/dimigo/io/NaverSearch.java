	...
	public static void main(String[] args) {		
	    ...
	    try {
	       ...
	       for(Movie s : movieList) {
	    	   str += (movieList.indexOf(s) + 1) + ". " + s.getTitle() + " - " + s.getActors() + "\n";
	    	   System.out.println((movieList.indexOf(s) + 1) + ". " + s.getTitle() + " - " + s.getActors());
	       }
	       
	       File moviesFile = new File("files/movies.txt");
